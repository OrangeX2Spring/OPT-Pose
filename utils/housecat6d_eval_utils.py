...
def compute_independent_mAP(final_results, synset_names, degree_thresholds=[360], shift_thresholds=[100], iou_3d_thresholds=[0.1], iou_pose_thres=0.1, use_matches_for_pose=True, logger=None):
    ...
    if logger is not None:
        ...
        logger.warning(f'3D IoU at 25 per category:{iou_3d_aps[1:, iou_thres_list.index(0.25)] * 100}')
        logger.warning(f'3D IoU at 50 per category:{iou_3d_aps[1:, iou_thres_list.index(0.5)] * 100}')
        logger.warning(f'3D IoU at 75 per category:{iou_3d_aps[1:, iou_thres_list.index(0.75)] * 100}')
        
        
        logger.warning(f'5 degree, 2cm per category:{pose_aps[1:, degree_thres_list.index(5), shift_thres_list.index(2)] * 100}')
        logger.warning(f'5 degree, 5cm per category:{pose_aps[1:, degree_thres_list.index(5), shift_thres_list.index(5)] * 100}')
        logger.warning(f'10 degree, 2cm per category:{pose_aps[1:, degree_thres_list.index(10), shift_thres_list.index(2)] * 100}')
        logger.warning(f'10 degree, 5cm per category:{pose_aps[1:, degree_thres_list.index(10), shift_thres_list.index(5)] * 100}')
