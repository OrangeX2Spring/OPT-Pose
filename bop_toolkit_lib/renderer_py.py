...
# Disable OpenGL_accelerate to avoid bufSize keyword argument issues
os.environ["PYOPENGL_PLATFORM"] = "egl"
os.environ["PYOPENGL_USE_ACCELERATE"] = "False"

# Additional fix: try to prevent OpenGL_accelerate from loading
try:
    import OpenGL
    ...
    # Force PyOpenGL to not use accelerate
...
class RendererPython(renderer.Renderer):
  ...
  def _draw_rgb(self, obj_id, mat_model, mat_view, mat_proj):
    ...
    safe_glReadPixels(0, 0, self.width, self.height, gl.GL_RGBA, gl.GL_FLOAT, rgb)
